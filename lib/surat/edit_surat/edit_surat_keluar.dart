...
class _HalamanEditSuratKState extends State<HalamanEditSuratK> {
  ...
  void initState() {
    ...
    // kategoriSuratController.text = widget.kategoriSurat!;
    tanggalSuratController.text = widget.tanggalSurat!;
    // fileSuratController.text = widget.fileSurat!;

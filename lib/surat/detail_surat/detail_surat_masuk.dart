...
import 'package:sudesapp/surat/edit_surat/edit_surat_masuk.dart';
...
class _DetailSuratMasukState extends State<DetailSuratMasuk> {
  ...
  void initState() {
    ...
    urlFile = "http://localhost:1337" + widget.url;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    // print("URL DOWNLOAD FILE : " + urlFile);
                    _downloadFile;
                    final download = _downloadFile();
                    print(download);
                  },
                  icon: const Icon(
                    Icons.download,
    ...
    Future<String?> download() async {
      ...
      if (externalDir != null) {
        ...
        if (result.statusCode == 200) {
          //download sukses
          final byteDownloaded = result.data;
          if (byteDownloaded != null) {
            final file = File("${externalDir.path}/download_file.pdf");
            print(file);
            file.writeAsBytesSync(byteDownloaded);
            print("file berhasil di save di ${file.path}");
            return " file berhasil di save di ${file.path}";
          } else {
            print("file kosong");
          }
        } else {
